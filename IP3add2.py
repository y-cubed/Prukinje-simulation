...
Oa_bind_IP3_f = smodel.SReac('Pb_bind_IP3_f', surfsys, olhs = [IP3], slhs = [Oa], srhs = [Ob])
Oa_bind_IP3_b = smodel.SReac('Pb_bind_IP3_b', surfsys, slhs = [Ob], orhs = [IP3], srhs = [Oa])
Oa_bind_IP3_f.setKcst(133)
Oa_bind_IP3_b.setKcst(1500)
